        ...
        <div class="row">
            <nav class="navbar navbar-expand fixed-top navbar-dark bg-primary">
                <div class="nav navbar-nav">
                    ...
                    <a class="nav-item nav-link" href="post&create">Créer un article</a>
                </div>
        </div>
...
<div><br>
    ...
    <a class="btn btn-blog pull-right marginBottom10 btn btn-info" role="button"
        href="edit&id=<?=$article['id']?>">Modifier</a>

    <a class="btn btn-blog pull-right marginBottom10" href="delete&id=<?=$article['id']?>">Supprimer</a>
        <hr />
</div>
<?php endforeach ?>